...
/*	2 for sleep list plus 2 per semaphore plus an entry for every queue
	in the multilevel feedback queue queue */
#ifndef NQENT
#define NQENT	(NPROC + 4 + NSEM + NSEM + 2 * NUM_PRIO_LVLS)
#endif
